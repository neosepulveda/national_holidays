...
module NationalHolidays
  module Countries
    ...
    def self.countries
      [ "angola", "australia", "austria", "belgium", "brazil", "canada", "china", "colombia", "croatia", "ethiopia", "france", "germany", "india", "ireland", "italy", "kenya", "norway", "portugal", "united_kingdom", "united_states" ]
    end
